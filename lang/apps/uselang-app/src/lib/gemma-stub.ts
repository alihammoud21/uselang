...
const CURATED: { match: (s: string) => boolean; byLang: LangMap }[] = [
  ...
  // call me a taxi / I need a taxi
  {
    match: (s) => /\b(?:call|get|need|want)\s+(?:me\s+)?(?:a\s+)?taxi\b|hail.*taxi/i.test(s),
    byLang: {
      zh: {
        phrase: "请帮我叫一辆出租车",
      ...
      es: {
        phrase: "Necesito un taxi, por favor.",
        phonetic: "neh-seh-SEE-toh oon TAK-see pohr fah-VOR",
        meaning: "I need a taxi, please.",
        context: "Simple and clear — works anywhere.",
        pronunciationTip: "Stress the verb syllable: ne-CE-si-to.",
        articulation: {
          tonguePlacement: "Tongue tap for soft 'r' sounds.",
          lipShape: "Open for 'ah'.",
          airflow: "Voiced and even.",
          stress: "neh-seh-SEE-toh.",
        },
      },
      fr: {
        phrase: "J'ai besoin d'un taxi, s'il vous plaît.",
        phonetic: "zhay buh-ZWAN duhn tak-SEE seel voo PLAY",
        meaning: "I need a taxi, please.",
        context: "Polite and direct — use at a hotel or on the street.",
        pronunciationTip: "'Besoin' has a nasal 'oin': buh-ZWAN.",
        articulation: {
          tonguePlacement: "Back of tongue for nasal 'oin'.",
          lipShape: "Round for final 'plaît'.",
          airflow: "Voiced.",
          stress: "buh-ZWAN, tak-SEE, seel voo PLAY.",
        },
      },
    },
  },
